...
#     # 本地视频
#     # video = cv2.VideoCapture(r'./Video/JinHao_2.mp4')
#     size = (960, 540)
#     # size = (1920, 1080)
#     flag = True
#     while flag:
...
#     print(fatiguePredict)
#     aaa = "fatiguePredict: " + str(fatiguePredict)
#     cv2.putText( aaa, (20, 30), 1, 4, (0, 255, 0), 2)
#     # print(fatiguePredict)
#     # 反归一化
#     # fatiguePredict = scaler.inverse_transform(fatiguePredict).astype(int)
#     # print(fatiguePredict)
#
...
def readVedio():
    print("readVedio")
    global E_ar, M_ar, H_ar, data, ear, mar, har, ZBData, aaa
    global EYE_AR_THRESH, EYE_AR_CONSEC_FRAMES, MAR_THRESH, PERCLOS_THRESH, HAR_THRESH, EYE_AR_THRESH, EYE_AR_CONSEC_FRAMES
    global PERCLOS_THRESH, MAR_THRESH, MOUTH_AR_CONSEC_FRAMES, HAR_THRESH, NOD_AR_CONSEC_FRAMES
    global hCOUNTER, hTOTAL, COUNTER, TOTAL, mTOTAL, mCOUNTER
    #通过摄像头读取帧图像
    ...
    # video = cv2.VideoCapture(0)
    # 本地视频
    video = cv2.VideoCapture(r'./Video/YL_2.mp4')
    # size = (960, 540)
    # size = (1920, 1080)
    flag = True
    while flag:
        ...
        if len(pre_Label) == 90:
            ...
            print(fatiguePredict)
            aaa = "fatiguePredict: " + str(fatiguePredict)
            # cv2.putText(img, aaa, (70, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            # print(fatiguePredict)
            # 反归一化
            # fatiguePredict = scaler.inverse_transform(fatiguePredict).astype(int)
            # print(fatiguePredict)
        ...
        cv2.putText(img, aaa, (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv2.imshow('video', img)
        k = cv2.waitKey(1)
